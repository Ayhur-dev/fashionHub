...
export const products: Product[] = [
  {
    ...
    details: [
      " Wrap-style mini dress with a lustrous woven finish",
      "Deep V-neckline",
      "Long sleeves with gathered cuffs",
      "Self-tie waist belt",
      "Fitted waist with soft pleating",
      "Flared mini skirt",
      "Draped front bodice",
      "Flowing silhouette with a subtle sheen",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Smooth leather-look finish",
      "Gathered opening",
      "Padded top handle",
      "Gold-tone chain shoulder straps",
      "Decorative gold-tone charm",
  ...
  },
  {
    ...
    details: [
      "Structured envelope clutch",
      "Woven leather-look finish",
      "Fold-over flap closure",
      "Top carry handle",
      "Gold-tone twist-lock fastening",
  ...
  },
  {
    ...
    otherSizes: [
      { name: "Marchese Leather Slipper", image: "/product-7a.jpg" },
    ],
    details: [
  ...
  },
  {
    ...
    otherSizes: [
      { name: "The Tailored saddle bag", image: "/product-8a.jpeg" },
    ],
    details: [
      "Structured rectangular silhouette",
      "Smooth leather-look finish",
      "Top zip closure",
      "Top carry handle",
      "Detachable shoulder strap attachments",
      "Gold-tone hardware",
      "Front logo detail",
      "Decorative hanging tag",
    ],
    material: "100% Linen",
    madeIn: "Made in Portugal",
    ref: "Ref. DRS008",
  ...
  },
  {
    ...
    details: [
      ...
      "Oval silhouette",
      "Tinted UV-protective lenses",
      "Molded nose bridge",
      "Slim temples with polished metal logo accents",
      "Curved temple tips for a secure fit",
    ],
    material: "100% Acetate, Tinted UV-protective lenses",
    madeIn: "Made in Italy",
    ref: "Ref. SUN00984SS00792311",
    completeLook: [
  ...
  },
  {
    ...
    details: [
      "Lightweight acetate frame",
      "Slim cat-eye silhouette",
      "Tinted UV-protective lenses",
      "Sculpted temples for a secure fit",
      "Smooth polished finish",
    ],
    material: "Frame: Acetate, Lens: UV-protective polycarbonate",
    madeIn: "Imported",
    ref: "Ref. SUN00918BK00154000",
    completeLook: [
      {
  ...
  },
  {
    ...
    details: [
      "Lightweight performance football jersey",
      "Breathable moisture-wicking fabric",
      "Ribbed V-neck collar",
      "Short sleeves with contrast cuffs",
      "Printed graphic panel design",
      "Embroidered crest and logo",
    ],
    material: "100% Recycled Polyester",
    madeIn: "Made in Uk",
    ref: "Ref. JSY00214NG00115000",
    completeLook: [
      {
